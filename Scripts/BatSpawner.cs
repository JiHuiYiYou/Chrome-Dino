...
public partial class BatSpawner : Timer
{
	...
	[Export] public float PosX = 1700;
	private float PosY;
	private int Add;

	public override void _Ready()
	{
		Add = GD.RandRange(0, 2);
		PosY = 270 + Add * 60;
		OneShot = false;
	...
	{
		GD.Print($"✅ Spawner 初始化: {Name} | Instance ID: {GetInstanceId()} | Parent: {GetParent().Name}");
